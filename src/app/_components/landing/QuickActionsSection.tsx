            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    <button 
                        ...
                        className="h-full group text-left flex-grow bg-slate-900/50 border border-indigo-700 p-8 rounded-xl transition-all duration-300 hover:border-yellow-400 hover:bg-slate-900 hover:shadow-2xl hover:shadow-yellow-400/20"
                    >
                    ...
                    <button 
                        ...
                        className="h-full group text-left flex-grow bg-slate-900/50 border border-indigo-700 p-8 rounded-xl transition-all duration-300 hover:border-green-400 hover:bg-slate-900 hover:shadow-2xl hover:shadow-green-400/20"
                    >
